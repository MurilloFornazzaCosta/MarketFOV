    ...
    function calcularTotal() {
        ...
        linhas.forEach(linha => {
            ...
            if (produtos[nomeProduto]) {
                ...
                produtos[nomeProduto] = { quantidade: quantidade, preco: preco * quantidade };
            }
        });
        ...
        for (const [nomeProduto, dados] of Object.entries(produtos)) {
            ...
            novaLinha.innerHTML = `
                ...
                <td>R$${(dados.preco / dados.quantidade).toFixed(2).replace('.', ',')}</td>
            `;
            corpoTabela.appendChild(novaLinha);
        }

        // Calcula o total
        total = Object.values(produtos).reduce((acc, dados) => acc + dados.preco, 0);
