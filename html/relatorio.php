...
<body>
    <div class="navbar">
        <div class="image-container">
            <!-- ../html/editarMercado.php?cnpj=<?php echo urlencode($mercadoLogado['cnpj']); ?> -->
            <button id="btnImg">
           ...
           Digite a senha do comércio:
            <form method="POST" action="/MarketFOV/php/verificarSenha.php">
                <div class="group">
                    ...
                    <input id="inputSenhaModal" class="input" type="password" placeholder="password" name="senha" required>
                </div>
