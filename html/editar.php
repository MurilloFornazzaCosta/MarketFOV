...
<div class="detalhesProduto">
    ...
    <form id="meuFormulario" action="../php/editarProdutos.php?id=<?php echo htmlspecialchars($id); ?>" method="POST">
        <label for="codigodebarra" id="textcdb">Código de Barras</label>
        <br>
        <input type="text" id="codigodebarra" name="codigodebarra" value="<?php echo htmlspecialchars($results['barCode']); ?>">
        ...
        <select name="tipo" id="tipo">
            ...
            <option value="limpeza" <?php if (strcasecmp($results['tipo'], 'limpeza') == 0) echo 'selected'; ?>>Produto de Limpeza</option>
            <option value="higiene" <?php if (strcasecmp($results['tipo'], 'higiene') == 0) echo 'selected'; ?>>Higiene Pessoal</option>
            <option value="alimentos" <?php if (strcasecmp($results['tipo'], 'alimentos') == 0) echo 'selected'; ?>>Alimentos</option>
            <option value="variados" <?php if (strcasecmp($results['tipo'], 'variados') == 0) echo 'selected'; ?>>Variados</option>
        </select>
